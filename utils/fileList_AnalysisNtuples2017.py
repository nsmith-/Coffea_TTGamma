...
fileset2017 = {
    "TTGamma2l_2017":[eosDir+"TTGamma_Dilepton_%i_AnalysisNtuple.root"%year],
    "TTGamma1l_2017":[eosDir+"TTGamma_SingleLept_%i_AnalysisNtuple.root"%year],
    "TTGamma0l_2017":[eosDir+"TTGamma_Hadronic_%i_AnalysisNtuple.root"%year],

    "TTbar2l_2017":[eosDir+"TTbarPowheg_Dilepton_%i_AnalysisNtuple.root"%year],
    "TTbar0l_2017":[eosDir+"TTbarPowheg_Hadronic_%i_AnalysisNtuple.root"%year],
    "TTbar1l_2017":[eosDir+"TTbarPowheg_Semilept_%i_AnalysisNtuple.root"%year],

    "ST_2017":[eosDir+"ST_tW_channel_%i_AnalysisNtuple.root"%year,
    ...
    "Wjets_2017":[eosDir+"W1jets_%i_AnalysisNtuple.root"%year,
    ...
    "DY_2017":[eosDir+"DYjetsM10to50_%i_AnalysisNtuple.root"%year,
           eosDir+"DYjetsM50_%i_AnalysisNtuple.root"%year,
           ],
    
    "WGamma_2017":[eosDir+"WGamma_01J_5f_%i_AnalysisNtuple.root"%year],
    "ZGamma_2017":[eosDir+"ZGamma_01J_5f_lowMass_%i_AnalysisNtuple.root"%year],

    "Diboson_2017":[eosDir+"WW_%i_AnalysisNtuple.root"%year,
               eosDir+"WZ_%i_AnalysisNtuple.root"%year,
               eosDir+"ZZ_%i_AnalysisNtuple.root"%year,
              ],
    "TTV_2017":[eosDir+"TTWtoLNu_%i_AnalysisNtuple.root"%year,
           eosDir+"TTWtoQQ_%i_AnalysisNtuple.root"%year,
           eosDir+"TTZtoLL_%i_AnalysisNtuple.root"%year,
          ],
    "QCD_2017":[eosDir+"GJets_HT100To200_%i_AnalysisNtuple.root"%year,
...
fileset_Data2017 = {
    "DataB_Ele_2017":[eosDir+"Data_SingleEle_b_%i_AnalysisNtuple.root"%year],
    "DataC_Ele_2017":[eosDir+"Data_SingleEle_c_%i_AnalysisNtuple.root"%year],
    "DataD_Ele_2017":[eosDir+"Data_SingleEle_d_%i_AnalysisNtuple.root"%year],
    "DataE_Ele_2017":[eosDir+"Data_SingleEle_e_%i_AnalysisNtuple.root"%year],
    "DataF_Ele_2017":[eosDir+"Data_SingleEle_f_%i_AnalysisNtuple.root"%year],

    "DataB_Mu_2017":[eosDir+"Data_SingleMu_b_%i_AnalysisNtuple.root"%year],
    "DataC_Mu_2017":[eosDir+"Data_SingleMu_c_%i_AnalysisNtuple.root"%year],
    "DataD_Mu_2017":[eosDir+"Data_SingleMu_d_%i_AnalysisNtuple.root"%year],
    "DataE_Mu_2017":[eosDir+"Data_SingleMu_e_%i_AnalysisNtuple.root"%year],
    "DataF_Mu_2017":[eosDir+"Data_SingleMu_f_%i_AnalysisNtuple.root"%year],
